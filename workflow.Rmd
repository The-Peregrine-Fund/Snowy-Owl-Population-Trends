...
-----------------------------------------------------------------------
# 1 Simulations: Can regression models detect population declines?
...
## 2.2 Does a random effect for site improve inference?
...
### 2.3.1 Check count data for autocorrelation
```{r,autocorr, eval=TRUE, warning=FALSE}
```
